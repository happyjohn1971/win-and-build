async function loadMemberAccount(){
 ...
 if(!status.emailVerified){panel.innerHTML='<h2>Check your email.</h2><p>Use the verification link in your email before opening your member account. Then sign in again to continue.</p><a class="btn full" href="/auth/login">Sign in again</a><a class="btn outline full" style="margin-top:12px" href="/auth/logout">Sign out</a>';return;}
